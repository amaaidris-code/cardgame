-- Reflected hits previously dealt damage straight to the opponent's HP
-- without honoring their active defense. A defending opponent now blocks
-- the reflected damage (0) unless the skill is "انعكاس لا يُصدّ"
-- (unblockable_reflect), which pierces defense and can only be absorbed.
