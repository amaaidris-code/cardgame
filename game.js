...
async function login(){
    ...
    // دخول الأدمن — اسم المستخدم المطلوب هو "Admin" بالضبط (حالة الأحرف
    // مهمة). الأهم: إذا فشل دخول الأدمن لأي سبب (كلمة مرور خاطئة، قفل مؤقت
    // بسبب محاولات فاشلة، انقطاع شبكة...) نعرض الخطأ الحقيقي ونخرج فورًا
    // ولا ننتقل أبدًا إلى دخول اللاعب — كانت الرسالة الناتجة "اسم المستخدم
    // أو كلمة المرور خاطئة" تخفي السبب الفعلي (مثل قفل الحساب أو خطأ الشبكة)
